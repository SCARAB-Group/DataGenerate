...
origLabelID_orig = "A01_"
path_result_orig = '../../Result/AdaptedCSVFiles150527_A01_'
fileNamePrefix_orig = "Result_2015_05_27_01_01_"
plateTemplate_orig = "_A150527_"
...
labelIDList = ["81101272", "81101273", "81101274", "81101275", "81101276", "81101277"]
...
for curFolderIndex in range(nrOfFolders):
    ...
    curLabelIDOriginal = labelIDList[curFolderIndex]
            ...
            while sampleIndex < len(methodList):
                ...
                for curRowItem in plateRowChar:
                    ...
                    for curColItem in plateColChar:
                        ...
                        curMotherSample = curLabelIDOriginal + methodList[sampleIndex][1] 
