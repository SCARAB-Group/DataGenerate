...
path_result_orig = '../../Result/Generated_XMLfiles_150603_B01_'
fileNamePrefix_orig = "MethodTests150603_02_"
origRid_orig = "B01_"
sampleTemplate_orig = "B01_"

dateStamp = "1506032"
  
sampleDrawtime = "20150603081001"
nrOfFolders = 1
...
for curFolderIndex in range(nrOfFolders):
    ...
    for curRidIndex in range(len(ridList)):
        #origRid = origRid_orig + str(curFolderIndex) + "_"
        #sampleTemplate = sampleTemplate_orig + str(curFolderIndex) + "_"

        origRid = ridList[curRidIndex] + dateStamp + "_"
        sampleTemplate = ridList[curRidIndex]
        curRid = origRid   
        ...
        for curSample in methodList:
            ...
            #xmlText = xmlText + xmltext_3 + sampleTemplate + curSample[1] + xmltext_4 + curSample[0] + xmltext_5 + xmltext_6    
            xmlText = xmlText + xmltext_3 + sampleTemplate + curSample[1] + xmltext_4 + curSample[0] + xmltext_5


        xmlText = xmlText + xmltext_6     
