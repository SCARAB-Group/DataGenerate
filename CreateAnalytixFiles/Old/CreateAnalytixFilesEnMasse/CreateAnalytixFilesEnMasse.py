...
templateRID = "EnMasse20130908_"
templateSample = "EM20130908_"
nrOfSamples = 500
boxCol = 8
BoxRow = 8
#curBoxName = "Plate_" + templateSample 

csv_filename_out = "Generated_csvFiles/Result_1870_01_01_01_01_01.csv"
...
for itemIndex in range(nrOfSamples):
    curIndex = convIndex(str(itemIndex),4)
    
    curLabelID1 = templateSample + curIndex + "ZB"
    curLabelID2 = templateSample + curIndex + "ZP"
    curRIDnr = templateRID + curIndex
    
    xml_filename_out = "Generated_XMLFiles/" + str(curRIDnr) + ".xml"
    ...
    curBoxName = "Plate_" + templateSample + findBoxIndex(itemIndex, boxCol, BoxRow)
    curBoxPos = findBoxPos(itemIndex, boxCol, BoxRow)
    aliquotName = curLabelID1 + "_sub1"
    
    csvline = [itemIndex + 1, curBoxName, curBoxName, curBoxPos, aliquotName, "0", "Correct pipetting", "150", "SMP_CAR_24_13x100_BDTube_eBlood_0001", "X", motherSampleName, "2013-09-05 09:37", "2013-09-05 09:40", "pkulmiln13001", "SN000", "0","0"]
